...
RLGSC::FList RLGSC::AdvancedOBSPadded::BuildOBS(const PlayerData& player, const GameState& state, const Action& prevAction) {
	FList result = {};
	...
	FList selfOBS = {};
	AddPlayerToOBSBetter(selfOBS, player, inv, ball);
	result += selfOBS;
